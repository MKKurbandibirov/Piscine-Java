...
public class TransactionsService {
	...
	public UsersArrayList getListOfUsers () {
	...
	public void performTransaction(int senderId, int recipientId, Integer amount) {
		try {
			...
			Transaction action2 = new Transaction(recipient, sender, Transaction.DEBIT, amount);
			...
			recipient.getList().addTransaction(action2);
